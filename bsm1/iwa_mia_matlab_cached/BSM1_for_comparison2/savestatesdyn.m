...
SNO2_meas = SNO2sensor(:,6);
SNO2_error = Qintrreg(:,1);
Qintr = Qintrreg(:,3);
SO5_error = SO5reg(:,1);
KLa5_regout = SO5reg(:,3);
KLa5 = kla5in(:,1);

CONTROL = [ SNO2_meas SNO2_error Qintr SO5_error KLa5_regout KLa5 ];

out = [ t Xin XINITDELAY XINIT1 XINIT2 XINIT3 XINIT4 XINIT5 SETTLERINIT XUNDER XEFF CONTROL ];
